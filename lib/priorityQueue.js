...
class PriorityQueue {
    ...
    init(comparator) {
        this._comparator = typeof (comparator) === 'function' ? comparator : _defaultComparator;
    ...
    offer(element) {
        ...
        while (pos > 0) {
            const parentPos = (pos % 2 === 0) ? (pos / 2 - 1) : (pos - 1) / 2;  // eslint-disable-line
    ...
    pop() {
        ...
        let pos = 0;
        let left = pos * 2 + 1;  // eslint-disable-line
        let right = left + 1;
        queue[pos] = tail;
        this._tailPos--;
        ...
        while (left < this._tailPos) {
            ...
            left = pos * 2 + 1; // eslint-disable-line
            right = left + 1;
        }
